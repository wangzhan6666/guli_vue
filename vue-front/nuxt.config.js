module.exports = {
  ...
  // 轮播图的插件：安装命令：npm install swiper vue-awesome-swiper --save
  // nuxt-swiper-plugin.js配置：① import VueAwesomeSwiper from 'vue-awesome-swiper'
  //                            ② import 'swiper/css/swiper.css'(nuxt.config.js中就不用加那个css的配置了) 
  plugins: [
